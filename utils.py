...
def get_contract_entry(contract, detailed_contract):
    ...
    'publicationDate': convert_date((detailed_contract.get('headerModel') or {}).get('publicationDate', '')),
    #'winnerCUI': winnerCUI,
    'estimatedContractValue': (detailed_contract.get('section524') or {}).get('estimatedContractValue', None),
    'totalContractValue': (detailed_contract.get('section524') or {}).get('totalContractValue', None),
    'currency': ((detailed_contract.get('section524') or {}).get('currency') or {}).get('text', ''),
